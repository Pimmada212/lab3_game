...
namespace lab3_game
{
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(myTexture, new Vector2(0, 0), new Rectangle(64 * 4, 64*2, 64*4, 64*44), Color.White);
            ...
            spriteBatch.Draw(myTexture, new Vector2(64 * 8, 64 * 2.5f), new Rectangle(64, 0, 64, 64), Color.White);

            spriteBatch.Draw(myTexture, new Vector2(64 * 9.7f, 64 * 1.5f), new Rectangle(64 * 2, 0, 64, 64), Color.White);
